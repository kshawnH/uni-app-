...
import { getGoodsByAPI } from '@/services/good'
...
const getGoodsByIdData = async () => {
  const res = await getGoodsByAPI(query.id)
...
//SKU组件实例
const skuPopopRef = ref<SkuPopupInstance>()
//计算被选中的值
const selectArrText = computed(() => {
  return skuPopopRef.value?.selectArr?.join(' ').trim() || '请选择商品规格'
})
//加入购物车事件
